...
public class Bomb extends Sprite{
    ...
    public Bomb(SimScreen screen, PhysicsImp properties){
        ...
        setBounds(0,0, properties.getRadius() * 2 / properties.getUnitScale(), properties.getRadius() * 2 /properties.getUnitScale());
...
//        BodyDef bdef = new BodyDef(); // creating a new body definition for the bomb
        bdef.position.set(properties.getStartDistance()/ properties.getUnitScale(), 600 / properties.getUnitScale()); // temporarily setting bomb position
        ...
        shape.setRadius(properties.getRadius()/ properties.getUnitScale()); // setting the circles radius (subject to change)
...
//        BodyDef bdef = new BodyDef(); // creating a new body definition for the bomb
        ...
        shape.setRadius(32/ properties.getUnitScale()); // setting the circles radius (subject to change)
    ...
    public void explode(){
        ...
        setBounds(0,0,64/ properties.getUnitScale(),64/ properties.getUnitScale());
